    ...
    <!-- END FAIXA -->
        ...
        <main class="cont-main">
            ...
            <div class="conjunto-main">
                <!-- START GRID ALBUM -->
                <div class="container">
                    <div class="item"><img src="{{asset('assets/images/banner-noticia3.jpg')}}"alt="album-noticia1" id="noticia1-album"></div>                                  
                    <div class="item"><img src="{{asset('assets/images/banner-noticia3.jpg')}}"alt="album-noticia2" id="noticia2-album"></div>
                    <div class="item"><img src="{{asset('assets/images/banner-noticia3.jpg')}}"alt="album-noticia3" id="noticia3-album"></div>
                    <div class="item"><img src="{{asset('assets/images/banner-noticia3.jpg')}}"alt="album-noticia4" id="noticia4-album"></div>
                </div>
                <!-- END GRID ALBUM -->
                ...
                <div class="container-noticias">
                    ...
                    <a href="#" target="_blank"><div class="noticias-blocos bloco1"><span class="n-cj-n" id="titulo-bloco1">NOTÍCIA1</span> <p class="t-cj-n" id="materia-bloco1" >Nosso serviço de atendimento ao consumidor está disponível para atendê-lo de segunda a sexta-feira das 8h às 17h.</p></div></a>
                    <a href="#" target="_blank"><div class="noticias-blocos bloco2"><span class="n-cj-n"  id="titulo-bloco2">NOTÍCIA1</span><p class="t-cj-n" id="materia-bloco2" >Nosso serviço de atendimento ao consumidor está disponível para atendê-lo de segunda a sexta-feira das 8h às 17h.</p></div></a>
                    <a href="#" target="_blank"><div class="noticias-blocos bloco3" ><span class="n-cj-n" id="titulo-bloco3">NOTÍCIA1</span><p class="t-cj-n" id="materia-bloco3" >Nosso serviço de atendimento ao consumidor está disponível para atendê-lo de segunda a sexta-feira das 8h às 17h.</p></div></a>
                    <a href="#" target="_blank"><div class="noticias-blocos bloco4" ><span class="n-cj-n" id="titulo-bloco4">NOTÍCIA1</span><p class="t-cj-n" id="materia-bloco4" >Nosso serviço de atendimento ao consumidor está disponível para atendê-lo de segunda a sexta-feira das 8h às 17h.</p></div></a>
                </div>
            </div>
            ...
            <h1 class="faixa-branca">VÍDEOS</h1>
            <!-- END BARRA NOTICIAS-VIDEOS -->
            <!-- START NOTICIAS COM VIDEO -->
            <div class="noticias-v-t">
                <div class="video-n">
                    <iframe class="video1" id="link-noticias-v-t" src="https://www.youtube.com/embed/MzetbI4APG4" frameborder="0" tittle="video-haaland" allowfullscreen width="690" height="390px"></iframe>
                </div>
                <div class="text-n">
                    <h1 id="titulo-noticias-v-t">HAALAND FAZ PINTURA, MANCHESTER CITY VENCE WEST HAM E RETOMA A LIDERANÇA DA PREMIER LEAGUE</h1>
                    <p id="materia-noticias-v-t">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</p>
                </div>
            </div>
